...
```
╭────────────────────────────╮  ╭────────────────────────────╮  ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
│         4 K stage          │  │        Cold finger         │  ┃        Laser diode         ┃
│       ╷ ╷ ╶╮ ╭─╴╷ ╷        │  │       ╶─┐╶─┐ ╶─┐╷ ╷        │  ┃         ╶─╮╷ ╷ ╶╮          ┃
│       ╰─┤  │ ├─╮╰─┤        │  │         │  │   │╰─┤        │  ┃         ┌─┘╰─┤  │          ┃
│         ╵•╶┴╴╰─╯  ╵        │  │         ╵  ╵•  ╵  ╵        │  ┃         ╰─╴  ╵•╶┴╴         ┃
│             K              │  │             K              │  ┃             K              ┃
│    temperature · 2s ago    │  │    temperature · 2s ago    │  ┃       > 10 · 2s ago        ┃
╰────────────────────────────╯  ╰────────────────────────────╯  ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛

╭────────────────────────────╮  ╭────────────────────────────╮  ╭────────────────────────────╮
│          Chamber           │  │           Laser            │  │         Wavemeter          │
│    ╶╮  ╭─╴╭─╴    ╭─╮╶─┐    │  │       ╶╮ ╭─╮╶╮  ╭─╮        │  │  ╶─╮ ╶─┐╭─╴╭─╴    ╶╮ ╷ ╷   │
│     │  ╰─╮╰─╮ ╶─╴│ │  │    │  │        │ │ │ │  ├─┤        │  │  ┌─┘   │├─╮├─╮ ╶┼╴ │ ╰─┤   │
│    ╶┴╴•╶─╯╶─╯e   ╰─╯  ╵    │  │       ╶┴╴╰─╯╶┴╴•╰─╯        │  │  ╰─╴•  ╵╰─╯╰─╯e   ╶┴╴  ╵   │
│            mbar            │  │             mW             │  │             Hz             │
│     pressure · 2s ago      │  │       power · 2s ago       │  │     frequency · 2s ago     │
╰────────────────────────────╯  ╰────────────────────────────╯  ╰────────────────────────────╯

╭────────────────────────────╮  ╭────────────────────────────╮  ╭────────────────────────────╮
│           Beam X           │  │         Bias rail          │  │        Dead sensor         │
│          ╶╮  ╶─╮╶─╮        │  │       ╭─╮ ╭─╮╶─┐╭─╮        │  │    ╶─╮ ╶─╮╭─╴    ╭─╮╭─╴    │
│       ╶─╴ │  ┌─┘ ─┤        │  │       │ │ ╰─┤  ││ │        │  │     ─┤ ┌─┘╰─╮ ╶─╴│ │├─╮    │
│          ╶┴╴•╰─╴╶─╯        │  │       ╰─╯•╶─╯  ╵╰─╯        │  │    ╶─╯•╰─╴╶─╯e   ╰─╯╰─╯    │
│             µm             │  │             V              │  │            mbar            │
│     position · 2s ago      │  │      voltage · 2s ago      │  │     pressure · 22h ago     │
╰────────────────────────────╯  ╰────────────────────────────╯  ╰────────────────────────────╯

                    14 sensors, 2 quiet · window 15m · every 1s · 00:48:06
```
